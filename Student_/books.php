...
?>
	...
	{
		echo "<tr style='color:black; width: 400px; margin-top:px; float:left;'>";
	...
	?> 
     		...
     		<tr style="color:black; width: 400px; margin-top:px; float:left;"></tr>
     	</table>
	...
	if (isset($_SESSION['login_user'])) {
		...
		echo "<div style='color: white; margin-left: 60px; font-size: 20px;'>";
		echo "<img class='img-circle profile_img' height=120 width=120 src='images/" . $_SESSION['pic'] . "'>";
		echo "<br><br>";
		echo "Welcome " . $_SESSION['login_user'];
		echo "</div><br><br>";
		echo "<div class='h'><a href='books.php'>Books</a></div>";
		echo "<div class='h'><a href='request.php'>Book Request</a></div>";
		echo "<div class='h'><a href='issue_info.php'>Issue Information</a></div>";
		echo "<div class='h'><a href='expired.php'>Expired List</a></div>";
		echo "</div>";
	}
	?>
